...
<body>
    ...
    <div class="custom-content">
        <div class="custom-text-container">
            ...
            <h1 class="custom-heading">Plataforma exclusiva para empleadores y administradores.</h1>
            <p class="custom-black-text">Edita, elimina y gestiona facturas y usuarios</p>

            <div class="custom-button-container">
                <a href="IndexFacturas.php" class="custom-link">
                    <button class="custom-button">Facturas</button>
                </a>
                <a href="reservas_admin.php" class="custom-link">
